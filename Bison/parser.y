...
variable_declaration: c variable_modifier data_type variable QMARK c 
	| c data_type variable QMARK c
	| c CLASS_NAME variable EQUAL object_instance QMARK c
	| c variable_modifier data_type variable EQUAL expression extra_variables QMARK c
	| c data_type variable EQUAL expression extra_variables QMARK c  
	;
